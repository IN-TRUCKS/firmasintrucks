...
<table cellpadding="0" cellspacing="0" border="0" style="font-family: 'Segoe UI', Arial, sans-serif; width: 500px !important; max-width: 500px !important; background: #ffffff; border-collapse: collapse;">
  <tr>
    <td width="170" style="padding: 16px; vertical-align: middle; text-align: center; width: 170px;">
      ...
      <table cellpadding="0" cellspacing="0" border="0" align="center" style="width: 140px; margin-top: 12px; border-collapse: collapse;">
        <tr>
          <td width="140" height="37" style="width: 140px; height: 37px; line-height: 0; font-size: 0;">
            <img src="${logoSrc}" alt="InTrucks Corp" width="140" height="37" style="display: block; width: 140px; height: 37px; max-width: 140px; max-height: 37px; border: none;" />
          </td>
        </tr>
      </table>
    </td>
